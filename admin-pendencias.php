...
if (isset($_GET['concluir'])) {
	extract($_GET);
	$query2 = $conexao->query("UPDATE tb_usuarios SET usu_alteracao = 0 WHERE usu_codigo = $concluir");
	header("Location: admin-pendencias.php");
}
?>
    ...
    <div class="container" style="padding-top: 20px;">
        <div class="panel panel-default">
            ...
            <table class="table">
                ...
                <tbody>
				<?php
				$query = $conexao->query("SELECT * FROM tb_usuarios where usu_alteracao=1");
                                ...
                                <div class="row">
                                            ...
                                            <span class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="opcoes">
                                                    ...
                                                    <li>
                                                        <a href="?concluir=<?php echo $row['usu_codigo'] ?>">
